...
/**
 * 简易仓库管理系统
 * 实现基本的物品管理功能：添加、查询、修改数量、删除
 */
public class SimpleWarehouseSystem {
    public static void main(String[] args) {
        WarehouseManager manager = new WarehouseManager();
        Scanner scanner = new Scanner(System.in);
        boolean running = true;
        
        System.out.println("=== 简易仓库管理系统 ===");
    ...
    private static void addItem(Scanner scanner, WarehouseManager manager) {
        System.out.println("\n=== 添加新物品 ===");
    ...
    private static void updateItemQuantity(Scanner scanner, WarehouseManager manager) {
        System.out.println("\n=== 更新物品数量 ===");
    ...
    private static void removeItem(Scanner scanner, WarehouseManager manager) {
        System.out.println("\n=== 删除物品 ===");
    ...
    private static void searchItem(Scanner scanner, WarehouseManager manager) {
        System.out.println("\n=== 查询物品 ===");
