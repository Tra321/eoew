...
public class ManagerDaoImpl implements ManagerDao {
    ...
    public void getLiveDormitoryFloor(String managerID) {
        ...
        try {
            con = BaseDao.getCon();
            String sql1 = "SELECT live.studentID,live.dormitoryFloor from live,teach where teach.dormitoryID = live.dormitoryID and managerID=?";
            ...
            /*String sql2 = "Insert into SELECT live.studentID,live.dormitoryFloor from live,teach where teach.dormitoryID = live.dormitoryID and managerID=? (studentID,dormitoryFloor) values(?,?)";
            int a = ps.executeUpdate();
            if (a > 0) {
    ...
    public void getAllDormitoryFloor(String managerID) {
        ...
        try {
            con = BaseDao.getCon();
            String sql = "select live.dormitoryID,student.studentName,live.dormitoryFloor from student,live,teach where live.studentID in (select live.studentID from live,teach where live.dormitoryID=teach.dormitoryID and teach.managerID =?);";
            ps=con.prepareStatement(sql);
            ps.setString(1, managerID);
