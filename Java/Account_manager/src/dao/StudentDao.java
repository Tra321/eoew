...
public interface StudentDao {
    ...
    public void getStuDormitoryFloor(String studentID);//查询获得楼层
    public void getAvaDormitory(String studentID);//查询可选宿舍
    public void chooseDormitory(String studentID,String dormitoryID,int dormitoryFloor);//宿舍管理
    public void deleteDormitory(String studentID,String dormitoryID);//删除宿舍管理
    public void printStuDormitoryFloor(String studentID);//打印个人楼层单
}
